...
nut_prod_petrol_harvesting_kg_tree = 20 * 2 * np.random.rand(trials)
...
#Establishment Total Impact by Category
...
def nut_prod_impact_calc():
    ...
    for i in range(trials):
        nut_prod_impact = nut_prod_harvester_kg_tree[i] * imp.unspecified_ag_machinery_impact_dict + \
            ...
            nut_prod_petrol_harvesting_kg_tree[i] * imp.petrol_impact_dict
...
fig.suptitle('Nut/Wood Establishment Impacts')
